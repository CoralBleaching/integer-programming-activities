...
def relaxacao_linear_mochila(lucros: Union[List[int], List[float]], 
                             pesos: Union[List[int], List[float]], 
                             capacidade: int, 
                             varfixas: Optional[Dict[int, float]] = None,
...
def branch_and_bound_mochila(lucros: Union[List[int], List[float]],
                             pesos: Union[List[int], List[float]],
                             capacidade: int,
                             verbose: bool=False,
                             tolerancia: float = 1e-6):
